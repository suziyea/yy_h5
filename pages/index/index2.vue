	...
	<view class="home_container">
      ...
      ">
				...
				<Flycard @onDragMove="onCardDragMove" @onDragStop="onCardDragStop" @onThrowDone="onCardThrowDone"
					...
					<view slot="firstCard" style="width: 100%; height: 100%">
						<view v-if="cards[0]" class="tantanCard" @click="clickCard">
							<image :src="cards[0].index_image_url" style="width: 100%; height: 100%" mode="aspectFill">
							</image>
						</view>
					</view>
					<view slot="secondCard" style="width: 100%; height: 100%">
						<view v-if="cards[1]" class="tantanCard">
							<image :src="cards[1].index_image_url" style="width: 100%; height: 100%" mode="aspectFill">
							</image>
						</view>
					</view>
					<view slot="thirdCard" style="width: 100%; height: 100%">
						<view v-if="cards[2]" class="tantanCard">
							<image :src="cards[2].index_image_url" style="width: 100%; height: 100%" mode="aspectFill">
							</image>
						</view>
					</view>
				</Flycard>
            ...
            " @click="nextSister">
              ...
              u-flex u-flex-center u-flex-items-center
            ">
						<image v-if="cards.length >= 1 && cards[0].is_like" src="/static/img/home_like.png"
							mode="aspectFill" @click="handleLikeSister(cards[0], 1)"></image>
						<image v-else src="/static/img/home_cancel_like.png" mode="aspectFill"
							@click="handleLikeSister(cards[0], 2)"></image>
					</view>
				</view>
			</view>
		</view>
