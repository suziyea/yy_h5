<template>
	...
	<view class="home_container">
		...
		<view class="tantanCardLike  u-flex u-flex-center">
			<view class="imgs u-flex u-flex-between u-flex-items-center">
				<image src="/static/icon/home_unlike.png" mode="aspectFill"></image>
				<image src="/static/icon/home_like.png" mode="aspectFill"></image>
			</view>
		</view>
