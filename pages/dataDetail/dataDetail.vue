<template>
	<view class="container_detail" v-if="showFlag">
		...
		<view class="sisterImg">
			<u-swiper :list="mm_sisterInfo.image_url" indicator indicatorMode="dot" height="416"
				indicatorStyle="bottom: 90px" indicatorActiveColor="#BD9762" circular></u-swiper>
		</view>
		<!-- 资料卡 -->
		...
		<view class="bottomTabbar u-flex u-flex-center u-flex-items-center">
			<view class="subscribe_view u-flex u-flex-items-center">
				...
				<view class="subscribeBtn u-flex u-flex-center u-flex-items-center" @click="beforeSubscribe">
		...
		<view v-if="phoneModalStatus">
			<phoneModal @confirmSubmit="handleUserSavePhone" @closePhoneModal="closePhoneModal"></phoneModal>
		</view>
