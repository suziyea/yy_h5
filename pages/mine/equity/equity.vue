<template>
  <view class="container_equity">
    <view
      class="container_equity_bg"
      :class="[this.current === 1 ? 'gold_bgColor' : '']"
    >
    ...
    <view class="websiteTip u-flex u-flex-center u-flex-items-center">
      <view
        class="text u-flex u-flex-center u-flex-items-center"
        :class="[
          this.current === 1
    ...
    <view class="member_price u-flex u-flex-center u-flex-items-center">
      <view
        class="content u-flex u-flex-items-center u-flex-between"
        :class="[
          this.current === 1
    ...
    <view class="privilege_container">
      <view class="privilege">
        <view
          class="title u-flex u-flex-items-center"
        ...
        <view class="groupIcon u-flex u-flex-wrap">
          ...
          >
            ...
            <view
              class="text u-flex u-flex-center"
              :class="[current === 1 ? 'gold_color' : 'silver_color']"
            >
              {{ item.text }}
            </view>
...
export default {
  ...
  methods: {
    ...
    async becomeMember() {
      ...
      let res = await becomeMemberOrder({ type });
    },
