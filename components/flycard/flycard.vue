<template>
	<view style="position: relative;height: 100%;width:100%;" :style="{paddingLeft:paddingLeft+'rpx'}">
		<!-- <view class="u-flex u-flex-center u-flex-items-center" :style="{paddingLeft:paddingLeft+'rpx'}"> -->
		<view style="position: absolute;left:50%;top:50%;transform: translate(-50%,-50%);" :style="{width:cardWidth+'rpx',height:cardHeight+'rpx'}">
		<!-- <view class="u-flex u-flex-center u-flex-items-center" :style="{width:cardWidth+'rpx',height:cardHeight+'rpx'}"> -->
			<view class="card" style="z-index: 13;" :style="{width:cardWidth+'rpx',height:cardHeight+'rpx',left:left+'rpx',top:top+'rpx','border-radius':borderRadius+'rpx',backgroundColor:cardBgColor}" :class="{'animation':isAnimating,'shadowEffect':hasShadow,'boderEffect':hasBorder}" @touchstart="touchStart" @touchmove="touchMove" @touchcancel="touchCancel" @touchend="touchCancel">
